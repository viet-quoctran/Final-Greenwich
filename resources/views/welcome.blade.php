          ...
          <div class="col-md-7 mx-auto">
            <form action="{{ route('guest.store') }}" method="POST">
                ...
                <div class="contact_form-container">
                    <div>
                        <div>
                            <input type="text" name="fullname" placeholder="Full Name" value="{{ old('name') }}" />
                            @error('fullname')
                        ...
                        <div class="">
                            <input type="text" name="message" placeholder="Message" class="message_input" value="{{ old('message') }}" />
                        </div>
                        <div class="btn-box">
